...
@Tag(name = "UserApi", description = "회원가입/회원정보 조회 API")
@RestController
...
public class UserController {
    ...
    @Operation (summary = "회원 가입",
                description = "request : email, password, nickname, adminToken")
    ...
    @Operation (summary = "회원 정보 조회",
                description = "새로고침 - token 확인(만료/불가한 token) & 유저 정보 전달 id, nickname, role")
    @GetMapping ("/auth")
